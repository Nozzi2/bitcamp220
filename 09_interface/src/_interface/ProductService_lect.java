...
public class ProductService_lect implements Product{

	public ProductDTO[] ar = new ProductDTO[5]; 
	...
	public void insertProduct() { //상품의 정보 입력
	...
	public void displayProduct() { //담겨있는 상품 출력
